        ...
        <div class="col-lg-10">
            ...
            <div class="stepper-wrapper">
                ...
                <div class="stepper-item" data-step="5" onclick="goToStep(5)">
                    ...
                    <span class="stepper-title">Element Dakwah</span>
                </div>
            ...
            <!-- Form Element -->
            <form id="formPendataanPemuda" action="<?= base_url('pendataan/simpan') ?>" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                <?= csrf_field() ?>
                    ...
                    <div class="card-body p-3 p-sm-4 p-md-5">
                        ...
                        <div class="form-step-actions d-flex flex-column-reverse flex-sm-row justify-content-between gap-2 mt-4 pt-3 border-top">
                            ...
                            <button type="button" class="btn btn-primary-pmd" onclick="validateAndNext(4)">
                                Selanjutnya: Element Dakwah <i class="bi bi-arrow-right ms-1"></i>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card card-custom mb-4 form-step-section" id="step-5">
                    <div class="card-body p-3 p-sm-4 p-md-5">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div>
                                <h4 class="card-title fw-bold mb-0">5. Keikutsertaan Element Dakwah</h4>
                                <p class="text-muted small mb-0">Pilih element dakwah yang Anda ikuti (opsional, bisa pilih lebih dari satu)</p>
                            </div>
                        </div>

                        <p class="text-secondary small mb-3">Centang element dakwah yang Anda ikuti:</p>
                        ...
                        <!-- Element Dakwah Lainnya -->
                        <div class="mt-4 p-3 bg-light rounded-3">
                            <label class="form-label fw-semibold text-slate-800 small mb-1">
                                <i class="bi bi-plus-circle me-1"></i> Element Dakwah Lainnya (Jika ada):
                            </label>
                ...
                <div class="card card-custom mb-4 form-step-section" id="step-8">
                    <div class="card-body p-3 p-sm-4 p-md-5">
                        ...
                        <div class="p-3 p-md-4 rounded-3 border bg-white mb-4">
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-2">
                                        <div class="review-item-label">Foto Profil</div>
                                        <div class="review-item-value" id="rev_foto_status">-</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-2">
                                        <div class="review-item-label">Keikutsertaan Element Dakwah / Unit Tugas</div>
                        ...
                        <!-- Upload Foto Profil (Field Terakhir) -->
                        <div class="card card-custom border p-3 p-sm-4 mb-4 shadow-sm" id="section-foto-profil">
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mb-3 pb-2 border-bottom">
                                <div class="d-flex align-items-center gap-2">
                                    <div class="rounded-circle bg-danger bg-opacity-10 text-danger p-2 d-inline-flex align-items-center justify-content-center" style="width: 38px; height: 38px;">
                                        <i class="bi bi-camera-fill fs-5"></i>
                                    </div>
                                    <div>
                                        <h5 class="fw-bold text-dark mb-0">
                                            Upload Foto Profil <span id="foto-required-star" class="text-danger">*</span>
                                        </h5>
                                        <small class="text-muted" id="foto-subtitle-text">Format didukung: JPG, JPEG, PNG, WEBP (Maks. 2 MB)</small>
                                    </div>
                                </div>
                                <span id="foto-requirement-badge" class="badge bg-danger rounded-pill px-3 py-2">
                                    <i class="bi bi-asterisk me-1"></i> Wajib untuk Laki-laki
                                </span>
                            </div>

                            <div class="alert alert-light border small text-muted mb-3" id="foto-instruction-text">
                                <i class="bi bi-info-circle text-danger me-1"></i> <strong>Ketentuan:</strong> Pendaftar <strong>Laki-laki wajib</strong> mengunggah foto bebas tampak depan. Pendaftar <strong>Perempuan tidak diwajibkan</strong> (opsional).
                            </div>
                            ...
                            <div class="row align-items-center g-3">
                                ...
                                <div class="col-12 col-sm-auto text-center">
                                    <div class="position-relative d-inline-block">
                                        <div id="foto-preview-container" class="rounded-3 border d-flex flex-column align-items-center justify-content-center bg-light overflow-hidden shadow-sm mx-auto" style="width: 120px; height: 145px;">
                                            <img id="foto-preview-img" src="" alt="Preview Foto" class="w-100 h-100" style="object-fit: cover; display: none;">
                                            <div id="foto-preview-placeholder" class="text-center text-muted p-2">
                                                <i class="bi bi-person-bounding-box fs-1 d-block text-secondary opacity-75"></i>
                                                <span class="text-xs text-muted" style="font-size: 0.72rem;">Belum ada foto</span>
                                            </div>
                                        </div>
                                        <button type="button" id="btn-remove-foto" class="btn btn-sm btn-danger rounded-circle position-absolute top-0 end-0 translate-middle shadow" style="display: none; width: 26px; height: 26px; padding: 0; line-height: 1;" title="Hapus / Batal Pilih Foto">
                                ...
                                <div class="col-12 col-sm">
                                    <label for="foto" class="form-label fw-semibold mb-1">
                                        Pilih Berkas Foto Profil <span id="foto-label-star" class="text-danger">*</span>
                                    </label>
                                    <div class="input-group">
                                        <span class="input-group-text bg-light text-muted"><i class="bi bi-image"></i></span>
                                        <input class="form-control" type="file" id="foto" name="foto" accept="image/jpeg,image/png,image/jpg,image/webp">
                                    </div>
                                    <div class="invalid-feedback d-block" id="foto-error-msg" style="display: none !important;">
                                        Foto profil wajib diunggah untuk pendaftar laki-laki.
                                    </div>
                                    <div class="form-text text-muted small mt-2">
                                        <i class="bi bi-check2-circle text-success me-1"></i> Gunakan pas foto berorientasi tegak (portrait), pencahayaan terang, dan wajah terlihat jelas.
                                    </div>
                                    <!-- Existing Photo Alert (Mode Update/MTA) -->
                                    <div id="existing-foto-info" class="alert alert-info py-2 px-3 mt-2 small mb-0 rounded-3" style="display: none;">
                                        <i class="bi bi-check-circle-fill text-info me-1"></i> <span id="existing-foto-text">Foto profil telah tercatat di sistem. Anda dapat mengunggah foto baru di atas jika ingin menggantinya.</span>
                                    </div>
                                </div>
                            </div>
                        </div>

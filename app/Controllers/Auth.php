...
class Auth extends BaseController
{
    ...
    public function login()
    {
        ...
        if ($this->request->is('post')) {
            ...
            // District-wide roles: superadmin, admin_pemuda (all Sragen, L), admin_pemudi (all Sragen, P)
            if (in_array($user['role_name'], ['superadmin', 'admin_pemuda', 'admin_pemudi'], true)) {
                $wilayahId   = null;
                $wilayahName = null;
                $cabangId    = null;
                $cabangName  = null;
            } elseif ($user['role_name'] === 'admin_cabang' && $cabangId && !$wilayahId) {
